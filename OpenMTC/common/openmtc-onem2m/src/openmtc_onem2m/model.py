...
class Group(AnnounceableResourceC,SubscribableResource):
    """See TS-0001 section 9.6.6"""
    ...
    memberTypeValidated = Attribute(bool,mandatory=False, accesstype=Attribute.RO)
    consistencyStrategy = Attribute(ConsistencyStrategyE, accesstype=Attribute.WO)
    groupName = UnicodeAttribute(mandatory=False)
    semanticSupportIndicator = UnicodeAttribute(mandatory=False, accesstype=Attribute.RO)
