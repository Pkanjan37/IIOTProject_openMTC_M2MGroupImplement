...
class CSEMaxNumberOfMemberExceeded(CSEError):
    response_status_code = STATUS_MAX_NUMBER_OF_MEMBER_EXCEEDED

class CSEMemberTypeInconsistent(CSEError):
    response_status_code = STATUS_MEMBER_TYPE_INCONSISTENT
